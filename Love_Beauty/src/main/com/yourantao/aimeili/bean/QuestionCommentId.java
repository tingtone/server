...
public class QuestionCommentId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof QuestionCommentId))
			return false;
		QuestionCommentId castOther = (QuestionCommentId) other;
