...
INSERT INTO `goods_map` VALUES (1,84,1);
INSERT INTO `goods_map` VALUES (2,119,1);
INSERT INTO `goods_map` VALUES (3,125,1);
INSERT INTO `goods_map` VALUES (4,345,1);
...
CREATE TABLE `shopping_cart` (
  ...
  `cart_status` tinyint(3) NOT NULL DEFAULT '3' COMMENT '0表示忽略，3表示可用',
  PRIMARY KEY (`cart_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
