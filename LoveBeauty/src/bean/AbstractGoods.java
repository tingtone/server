...
public abstract class AbstractGoods implements java.io.Serializable {
	...
	/** full constructor */
	public AbstractGoods(Integer providerId, Integer brandId,
			Integer categoryId, String goodsName, String goodsThumb,
			String goodsImages, Float goodsPrice, String goodsUrl,
			Float goodsScore, String goodsSkin, String goodsAge,
