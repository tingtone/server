...
public abstract class AbstractReport implements java.io.Serializable {
	...
	/** full constructor */
	public AbstractReport(Integer userId, String reportTags,
			String reportImages, String reportTitle, Short contentType,
			String reportContent, Integer reportRank, Timestamp addTime) {
		this.userId = userId;
