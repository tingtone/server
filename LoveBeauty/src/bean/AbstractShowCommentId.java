...
/**
 * AbstractShowCommentId entity provides the base persistence definition of the
 * ShowCommentId entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractShowCommentId implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractShowCommentId() {
	}

	/** full constructor */
	public AbstractShowCommentId(Integer showId, Integer userId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AbstractShowCommentId))
			return false;
		AbstractShowCommentId castOther = (AbstractShowCommentId) other;
