...
/**
 * AbstractDiaryCommentId entity provides the base persistence definition of the
 * DiaryCommentId entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractDiaryCommentId implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractDiaryCommentId() {
	}

	/** full constructor */
	public AbstractDiaryCommentId(Integer diaryId, Integer userId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AbstractDiaryCommentId))
			return false;
		AbstractDiaryCommentId castOther = (AbstractDiaryCommentId) other;
