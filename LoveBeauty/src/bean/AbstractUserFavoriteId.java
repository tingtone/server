...
/**
 * AbstractUserFavoriteId entity provides the base persistence definition of the
 * UserFavoriteId entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractUserFavoriteId implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractUserFavoriteId() {
	}

	/** full constructor */
	public AbstractUserFavoriteId(Integer favoriteId, Integer userId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AbstractUserFavoriteId))
			return false;
		AbstractUserFavoriteId castOther = (AbstractUserFavoriteId) other;
