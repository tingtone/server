...
/**
 * AbstractReportGoodsId entity provides the base persistence definition of the
 * ReportGoodsId entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractReportGoodsId implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractReportGoodsId() {
	}

	/** full constructor */
	public AbstractReportGoodsId(Integer reportId, Integer goodsId,
			Float goodsScore) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AbstractReportGoodsId))
			return false;
		AbstractReportGoodsId castOther = (AbstractReportGoodsId) other;
